...
type _BalanceWithAssets BalanceWithAssets
...
func (o *BalanceWithAssets) SetExpiresAtNil() {
	o.ExpiresAt.Set(nil)
}
...
func (o *BalanceWithAssets) UnmarshalJSON(data []byte) (err error) {
	...
	varBalanceWithAssets := _BalanceWithAssets{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBalanceWithAssets)

	if err != nil {
		return err
	}

	*o = BalanceWithAssets(varBalanceWithAssets)
