...
type _WalletSubject WalletSubject
...
func (o *WalletSubject) UnmarshalJSON(data []byte) (err error) {
	...
	varWalletSubject := _WalletSubject{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWalletSubject)

	if err != nil {
		return err
	}

	*o = WalletSubject(varWalletSubject)
