...
type _ListWalletsResponseCursor ListWalletsResponseCursor
...
func (o *ListWalletsResponseCursor) UnmarshalJSON(data []byte) (err error) {
	...
	varListWalletsResponseCursor := _ListWalletsResponseCursor{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListWalletsResponseCursor)

	if err != nil {
		return err
	}

	*o = ListWalletsResponseCursor(varListWalletsResponseCursor)
