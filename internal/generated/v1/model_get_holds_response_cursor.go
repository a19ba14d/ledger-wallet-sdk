...
type _GetHoldsResponseCursor GetHoldsResponseCursor
...
func (o *GetHoldsResponseCursor) UnmarshalJSON(data []byte) (err error) {
	...
	varGetHoldsResponseCursor := _GetHoldsResponseCursor{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetHoldsResponseCursor)

	if err != nil {
		return err
	}

	*o = GetHoldsResponseCursor(varGetHoldsResponseCursor)
