...
type _GetBalanceResponse GetBalanceResponse
...
func (o *GetBalanceResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGetBalanceResponse := _GetBalanceResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetBalanceResponse)

	if err != nil {
		return err
	}

	*o = GetBalanceResponse(varGetBalanceResponse)
