...
import (
	...
	ledgerwalletsdk "github.com/a19ba14d/ledger-wallet-sdk"                     // 修正导入路径
...
type IWallet interface {
	...
	ListWallets(ctx context.Context, params ledgerwalletsdk.ListWalletsParams) (*walletsclient.ListWalletsResponseCursor, error)
	...
	ListHolds(ctx context.Context, params ledgerwalletsdk.ListHoldsParams) (*walletsclient.GetHoldsResponseCursor, error)
	...
	GetTransactions(ctx context.Context, params ledgerwalletsdk.GetTransactionsParams) (*walletsclient.GetTransactionsResponseCursor, error)
