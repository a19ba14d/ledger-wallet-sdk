...
func (s *sWallet) GetTransactions(ctx context.Context, params sdkTypes.GetTransactionsParams) (*walletsclient.GetTransactionsResponseCursor, error) { // Use sdkTypes
	...
	apiReq := apiClient.WalletsV1API.GetTransactions(ctx) // Use apiClient
